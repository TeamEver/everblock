...
return [
    ...
    'src/PrettyBlocks/BlockDefinitionContext.php',
    'src/PrettyBlocks/BlockProviderInterface.php',
    'src/PrettyBlocks/BlockRegistry.php',
    'src/PrettyBlocks/BlockRegistryFactory.php',
    'src/PrettyBlocks/Blocks/AccordeonBlockProvider.php',
    'src/PrettyBlocks/Blocks/AlertBlockProvider.php',
    'src/PrettyBlocks/Blocks/BrandsBlockProvider.php',
    'src/PrettyBlocks/Blocks/ButtonBlockProvider.php',
    'src/PrettyBlocks/Blocks/CardBlockProvider.php',
    'src/PrettyBlocks/Blocks/CategoryHighlightBlockProvider.php',
    'src/PrettyBlocks/Blocks/CategoryPriceBlockProvider.php',
    'src/PrettyBlocks/Blocks/CategoryProductsBlockProvider.php',
    'src/PrettyBlocks/Blocks/CategoryTabsBlockProvider.php',
    'src/PrettyBlocks/Blocks/ContactBlockProvider.php',
    'src/PrettyBlocks/Blocks/CountdownBlockProvider.php',
    'src/PrettyBlocks/Blocks/CountersBlockProvider.php',
    'src/PrettyBlocks/Blocks/CoverBlockProvider.php',
    'src/PrettyBlocks/Blocks/CtaBlockProvider.php',
    'src/PrettyBlocks/Blocks/DividerBlockProvider.php',
    'src/PrettyBlocks/Blocks/DownloadsBlockProvider.php',
    'src/PrettyBlocks/Blocks/EverblockBlockProvider.php',
    'src/PrettyBlocks/Blocks/ExitIntentBlockProvider.php',
    'src/PrettyBlocks/Blocks/FlashDealsBlockProvider.php',
    'src/PrettyBlocks/Blocks/GalleryBlockProvider.php',
    'src/PrettyBlocks/Blocks/GmapBlockProvider.php',
    'src/PrettyBlocks/Blocks/GuidedSelectorBlockProvider.php',
    'src/PrettyBlocks/Blocks/HeadingBlockProvider.php',
    'src/PrettyBlocks/Blocks/IframeBlockProvider.php',
    'src/PrettyBlocks/Blocks/ImageMapBlockProvider.php',
    'src/PrettyBlocks/Blocks/ImgBlockProvider.php',
    'src/PrettyBlocks/Blocks/ImgSliderBlockProvider.php',
    'src/PrettyBlocks/Blocks/LayoutBlockProvider.php',
    'src/PrettyBlocks/Blocks/LinkListBlockProvider.php',
    'src/PrettyBlocks/Blocks/LoginBlockProvider.php',
    'src/PrettyBlocks/Blocks/LookbookBlockProvider.php',
    'src/PrettyBlocks/Blocks/MasonryGalleryBlockProvider.php',
    'src/PrettyBlocks/Blocks/ModalBlockProvider.php',
    'src/PrettyBlocks/Blocks/Module1BlockProvider.php',
    'src/PrettyBlocks/Blocks/MysteryBoxesBlockProvider.php',
    'src/PrettyBlocks/Blocks/PodcastsBlockProvider.php',
    'src/PrettyBlocks/Blocks/PricingTableBlockProvider.php',
    'src/PrettyBlocks/Blocks/ProductHighlightBlockProvider.php',
    'src/PrettyBlocks/Blocks/ProductSelectorBlockProvider.php',
    'src/PrettyBlocks/Blocks/ReassuranceBlockProvider.php',
    'src/PrettyBlocks/Blocks/RowBlockProvider.php',
    'src/PrettyBlocks/Blocks/ScratchCardBlockProvider.php',
    'src/PrettyBlocks/Blocks/ScrollVideoBlockProvider.php',
    'src/PrettyBlocks/Blocks/SharerBlockProvider.php',
    'src/PrettyBlocks/Blocks/ShoppingCartBlockProvider.php',
    'src/PrettyBlocks/Blocks/ShortcodeBlockProvider.php',
    'src/PrettyBlocks/Blocks/SlotMachineBlockProvider.php',
    'src/PrettyBlocks/Blocks/SocialLinksBlockProvider.php',
    'src/PrettyBlocks/Blocks/SpacerBlockProvider.php',
    'src/PrettyBlocks/Blocks/SpecialEventBlockProvider.php',
    'src/PrettyBlocks/Blocks/TabBlockProvider.php',
    'src/PrettyBlocks/Blocks/TestimonialBlockProvider.php',
    'src/PrettyBlocks/Blocks/TestimonialSliderBlockProvider.php',
    'src/PrettyBlocks/Blocks/TextAndImageBlockProvider.php',
    'src/PrettyBlocks/Blocks/TocBlockProvider.php',
    'src/PrettyBlocks/Blocks/VideoGalleryBlockProvider.php',
    'src/PrettyBlocks/Blocks/VideoProductsBlockProvider.php',
    'src/PrettyBlocks/Blocks/WheelOfFortuneBlockProvider.php',
    'src/Shortcode/Handler/AbstractShortcodeHandler.php',
    'src/Shortcode/Handler/AddToCartShortcodeHandler.php',
    'src/Shortcode/Handler/CartShortcodeHandler.php',
    'src/Shortcode/Handler/CatalogShortcodeHandler.php',
    'src/Shortcode/Handler/CmsShortcodeHandler.php',
    'src/Shortcode/Handler/EverblockReferenceShortcodeHandler.php',
    'src/Shortcode/Handler/FormShortcodeHandler.php',
    'src/Shortcode/Handler/GeneralContentShortcodeHandler.php',
    'src/Shortcode/Handler/HookShortcodeHandler.php',
    'src/Shortcode/Handler/MapShortcodeHandler.php',
    'src/Shortcode/Handler/MediaShortcodeHandler.php',
    'src/Shortcode/Handler/ProductListingShortcodeHandler.php',
    'src/Shortcode/Handler/ProductShortcodeHandler.php',
    'src/Shortcode/Handler/RelatedProductShortcodeHandler.php',
    'src/Shortcode/Handler/ShopShortcodeHandler.php',
    'src/Shortcode/Handler/StoreShortcodeHandler.php',
    'src/Shortcode/Handler/SubcategoryShortcodeHandler.php',
    'src/Shortcode/Handler/UtilityShortcodeHandler.php',
    'src/Shortcode/Handler/WidgetShortcodeHandler.php',
    'src/Shortcode/ShortcodeHandlerInterface.php',
    'src/Shortcode/ShortcodeHandlerRegistry.php',
    'src/Shortcode/ShortcodeHandlerRegistryFactory.php',
