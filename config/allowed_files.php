...
return [
    ...
    'tests/Functional/AdminRoutingTest.php',
    'tests/Stubs/PHPUnit/Framework/TestCase.php',
    'tests/Stubs/PrestaShop/PrestaShop/Adapter/Module/Repository/ModuleRepository.php',
    'tests/Stubs/PrestaShopBundle/Controller/Admin/FrameworkBundleAdminController.php',
    'tests/Stubs/Symfony/Component/HttpFoundation/Response.php',
    'tests/Stubs/Symfony/Component/Routing/Generator/UrlGeneratorInterface.php',
    'tests/Stubs/Symfony/Contracts/Translation/TranslatorInterface.php',
    'tests/Stubs/Context.php',
    'tests/Stubs/Link.php',
    'tests/Stubs/Module.php',
    'tests/Stubs/Translator.php',
    'tests/Stubs/bootstrap.php',
