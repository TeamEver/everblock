...
class HookGridDefinitionFactory
{
    /**
    ...
    public function getDefinition(): array
    {
        ...
        return [
            ...
            'bulk_actions' => [
                'enable' => [
                    'label' => $this->trans('Enable selected'),
                    'confirm' => $this->trans('Enable selected items?'),
                ],
                'disable' => [
                    'label' => $this->trans('Disable selected'),
                    'confirm' => $this->trans('Disable selected items?'),
                ],
                'delete' => [
