...
use Db;
use Everblock\Tools\Grid\Query\ShortcodeQueryBuilder;

if (!defined('_PS_VERSION_') && php_sapi_name() !== 'cli') {
    exit;
}

class ShortcodeGridDataFactory
{
    /**
     * @var ShortcodeQueryBuilder
     */
    private $queryBuilder;

    public function __construct(ShortcodeQueryBuilder $queryBuilder)
    {
