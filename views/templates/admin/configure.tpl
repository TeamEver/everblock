...
<div class="alert alert-info">
    ...
    <p>{l s='A new tab has appeared in the administration of your store, named "HTML Blocks"' mod='everblock'}</p>
    <br>
    ...
    <p>{l s='You can add hooks to your store by contacting us or asking your technician to do it.' mod='everblock'}</p>
    <br>
