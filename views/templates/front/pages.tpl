...
{block name='page_title'}
  {l s='Pages' d='Modules.Everblock.Front'}
{/block}

{block name='page_content'}
  <section class="everblock-pages-list d-flex flex-column gap-4"
           aria-label="{l s='Pages list' d='Modules.Everblock.Front'}">

    {if !empty($everblock_pages)}
      <div class="row">
    ...
    {else}
      <p class="alert alert-info">
        {l s='No page available yet.' d='Modules.Everblock.Front'}
      </p>
    {/if}
