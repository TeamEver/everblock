...
- `[categoryproducts nb="8" orderby="date_add" orderway="DESC"]`: Displays products from the categories of the current product.
...
- `[categoryproducts nb="8" orderby="date_add" orderway="DESC"]` : Affiche les produits des catégories du produit courant.
...
- `[categoryproducts nb="8" orderby="date_add" orderway="DESC"]`: Muestra productos de las categorías del producto actual.
...
- `[categoryproducts nb="8" orderby="date_add" orderway="DESC"]`: Mostra i prodotti delle categorie del prodotto in visualizzazione.
